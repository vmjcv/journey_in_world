...
const GASLIGHTER:= {
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_texture": preload("res://addons/cfc/assets/enemies/lantern-flame.png"),
	"_character_art": "Lorc",
}
const FEARMONGER:= {
	"Name": "Fearmonger",
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_art_scene": "res://addons/cfc/src/dreamscape/CombatElements/Enemies/Art/fearmonger.tscn",
...
const THE_LAUGHING_ONE:= {
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_art_scene": "res://addons/cfc/src/dreamscape/CombatElements/Enemies/Art/the_laughing_one.tscn",
	"_character_art": "insomniac_lemon",
}
const THE_CRITIC:= {
	"Name": "The Critic",
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_texture": preload("res://addons/cfc/assets/enemies/tapir.png"),
...
const CLOWN:= {
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_texture": preload("res://addons/cfc/assets/enemies/clown.png"),
	"_character_art": "Delapouite",
}
const BUTTERFLY:= {
	"Name": "Butterfly",
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_texture": preload("res://addons/cfc/assets/enemies/butterfly.png"),
	"_character_art": "Lorc",
		}
...
const BROKEN_MIRROR:= {
	...
	"_texture_size_x": "120",
	"_texture_size_y": "120",
	"_texture": preload("res://addons/cfc/assets/enemies/cracked-glass.png"),
	"_character_art": "Lorc"
}
#	"Spider": {
#		"Type": "Phobia",
