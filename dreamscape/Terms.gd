...
const ACTIVE_EFFECTS := {
	"advantage": {
		"name": "Advantage",
		"icon": preload("res://addons/cfc/assets/icons/crow-dive.png"),
		"generic_description": "{effect_name}: Doubles damage done by Interpretations.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/crow-dive.png",
	...
	"buffer":  {
		"name": "Fascination",
		"icon": preload("res://addons/cfc/assets/icons/star-struck.png"),
		"generic_description": "{effect_name}: Provides delayed Immersion.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/star-struck.png",
	...
	"disempower": {
		"name": "Confusion",
		"icon": preload("res://addons/cfc/assets/icons/misdirection.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/misdirection.png",
	...
	"empower": {
		"name": "Clarity",
		"icon": preload("res://addons/cfc/assets/icons/extra-lucid.png"),
		"generic_description": "{effect_name}: Increases interpretation dealt by percentage.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/extra-lucid.png",
		"description": "{effect_name} ({effect_icon}): {attack} {damage_verb} by this {entity} is increased by 30%.\n"\
				+ "Reduce these stacks by 1 at the end of the turn."
	},
	"strengthen": {
		"name": "Focus",
		"icon": preload("res://addons/cfc/assets/icons/templar-eye.png"),
		"generic_description": "{effect_name}: Increases interpretation dealt by exact amount.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/templar-eye.png",
	...
	"fortify": {
		"name": "Courage",
		"icon": preload("res://addons/cfc/assets/icons/beams-aura.png"),
		"generic_description": "{effect_name}: Prevents concentration from expiring each turn.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/beams-aura.png",
	...
	"burn": {
		"name": "Envy",
		"icon": preload("res://addons/cfc/assets/icons/wrapped-heart.png"),
		"generic_description": "{effect_name}: Automatically adds preventable interpretation each turn.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/wrapped-heart.png",
	...
	"vulnerable": {
		"name": "Shaken",
		"icon": preload("res://addons/cfc/assets/icons/cracked-shield.png"),
		"generic_description": "{effect_name}: Reduces amount of Perplexity on Torments.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/cracked-shield.png",
		"description": "{effect_name} ({effect_icon}): {defence} added to this {entity} is reduced by 25%.\n" \
				+ "Reduce these stacks by 1 at the end of the turn."
	},
	"thorns": {
		"name": "Retaliation",
		"icon": preload("res://addons/cfc/assets/icons/light-thorny-triskelion.png"),
		"generic_description": "{effect_name}: Interprets torments as they stress the dreamer.",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/light-thorny-triskelion.png",
	...
	"outrage": {
		...
		"icon": preload("res://addons/cfc/assets/icons/enrage.png"),
	},
	"creative_block": {
		"name": "Creative Block",
		"description": "{effect_name}: {entity} cannot upgrade any more cards this encounter.",
		"icon": preload("res://addons/cfc/assets/icons/brain-freeze.png"),
	},
	...
	"laugh_at_danger":  {
		...
		"icon": preload("res://addons/cfc/assets/icons/delighted.png"),
	},
	"nothing_to_fear":  {
		...
		"icon": preload("res://addons/cfc/assets/icons/one-eyed.png"),
	},
	"rubber_eggs":  {
		"name": "Rubber Eggs",
		...
		"icon": preload("res://addons/cfc/assets/icons/egg-defense.png"),
	},
	"nunclucks":  {
		"name": "Nunclucks",
		...
		"icon": preload("res://addons/cfc/assets/icons/nunchaku.png"),
	},
	"unassailable":  {
		"name": "Unassailable",
		...
		"icon": preload("res://addons/cfc/assets/icons/psychic-waves.png"),
	},
	"master_of_skies":  {
		...
		"icon": preload("res://addons/cfc/assets/icons/wing-cloak.png"),
	},
	"zen_of_flight":  {
		"name": "Zen of Flight",
		...
		"icon": preload("res://addons/cfc/assets/icons/windy-stripes.png"),
	},
	"absurdity_unleashed":  {
		...
		"icon": preload("res://addons/cfc/assets/icons/absurdity-unleashed.png"),
	},
	"brilliance":  {
		"name": "Brilliance",
		...
		"icon": preload("res://addons/cfc/assets/icons/mad-scientist.png"),
	},
	"recall":  {
		"name": "Recall",
		...
		"icon": preload("res://addons/cfc/assets/icons/think.png"),
	},
	"eureka":  {
		"name": "Eureka!",
		...
		"icon": preload("res://addons/cfc/assets/icons/wisdom.png"),
	},
}
...
const GENERIC_TAGS := {
	"risky": {
		"name": "Risky",
		"icon": preload("res://addons/cfc/assets/icons/tightrope.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/tightrope.png",
		"generic_description": "{effect_name} ({effect_icon}): Increases Anxiety taken by Dreamer."},
	"relax":  {
		"name": "Relax",
		"icon": preload("res://addons/cfc/assets/icons/meditation.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/meditation.png",
		"generic_description": "{effect_name} ({effect_icon}): Reduces Dreamer {anxiety}."},
	"purpose": {
		"name": "Purpose",
		"icon": preload("res://addons/cfc/assets/icons/concentration-orb.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/concentration-orb.png",
		"generic_description": "{effect_name} ({effect_icon}): Provides immersion."},
	"chain": {
		"name": "Chain",
		"icon": preload("res://addons/cfc/assets/icons/crossed-chains.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/crossed-chains.png",
		"generic_description": "{effect_name} ({effect_icon}): Repeatable card effects."},
	"swift": {
		"name": "Swift",
		"icon": preload("res://addons/cfc/assets/icons/windy-stripes.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/windy-stripes.png",
		"generic_description": "{effect_name} ({effect_icon}): Provides card draw."},
	"slumber": {
		"name": "Slumber",
		"icon": preload("res://addons/cfc/assets/icons/sleepy.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/sleepy.png",
		"generic_description": "{effect_name} ({effect_icon}): A phase of deep sleep which typically causes forgetfulness."},
	"fading": {
		"name": "Fading",
		"icon": preload("res://addons/cfc/assets/icons/empty-hourglass.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/empty-hourglass.png",
	...
	"spark": {
		"name": "Spark",
		"icon": preload("res://addons/cfc/assets/icons/idea.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/idea.png",
		"generic_description": "{effect_name} ({effect_icon}): Reshuffles the deck."},
	"alpha": {
		"name": "Intuition",
		"icon": preload("res://addons/cfc/assets/icons/light-bulb.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/light-bulb.png",
		"generic_description": "[color=purple]{effect_name} ({effect_icon}): This card will always be in the starting hand.[/color]"},
	"omega": {
		"name": "Enigma",
		"icon": preload("res://addons/cfc/assets/icons/omega.png"),
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/omega.png",
...
const GENERIC_CARD_BBCODE := {
	"damage": {
		"name": "Interpretation",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/magnifying-glass.png",
	},
	"defence": {
		"name": "Confidence",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/shield.png",
	},
	"perplexity": {
		"name": "Perplexity",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/shield.png",
	...
	"stress": {
		"name": "Stress",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/terror.png",
	},
	"anxiety": {
		"name": "Anxiety",
		"rich_text_icon": "res://addons/cfc/fonts/rich_text_icons/heart-beats.png",
	},
	"exhaust": {
		"name": "Forget",
