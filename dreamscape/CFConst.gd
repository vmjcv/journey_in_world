...
const PATH_CUSTOM := "res://addons/cfc/src/dreamscape/"
...
const PATH_ASSETS := "res://addons/cfc/assets/"
...
const PATH_OVERRIDABLE_UTILS := PATH_CUSTOM + "OverridableUtils.gd"
...
const PATH_SCRIPTING_ENGINE := PATH_CUSTOM + "ScriptingEngine.gd"
...
const REMOVE_FROM_GAME_SHADER := preload("res://addons/cfc/shaders/consume.shader")
