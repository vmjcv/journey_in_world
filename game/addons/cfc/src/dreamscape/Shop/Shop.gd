...
const CARD_SHOP_SCENE = preload("res://addons/cfc/src/dreamscape/Shop/ShopCardChoice.tscn")
const CARD_CHOICE_SCENE = preload("res://addons/cfc/src/dreamscape/ChoiceCardObject.tscn")
