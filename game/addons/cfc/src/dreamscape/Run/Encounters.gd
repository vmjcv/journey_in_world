	...
	for option in new_options:
		match option:
			...
			Terms.RUN_ACCUMULATION_NAMES.rest:
				journal_options.append(preload("res://addons/cfc/src/dreamscape/Run/NCE/Rest.gd").new())
			Terms.RUN_ACCUMULATION_NAMES.shop:
				journal_options.append(preload("res://addons/cfc/src/dreamscape/Run/NCE/Shop.gd").new())
			Terms.RUN_ACCUMULATION_NAMES.artifact:
				journal_options.append(preload("res://addons/cfc/src/dreamscape/Run/NCE/Artifact.gd").new())
			Terms.RUN_ACCUMULATION_NAMES.nce:
				journal_options.append(preload("res://addons/cfc/src/dreamscape/Run/NCE/RandomNCE.gd").new())
