...
const EXPLANATIONS = {
	"interpretation": "Interpretation ([img=24x24]res://addons/cfc/fonts/rich_text_icons/magnifying-glass.png[/img]): "\
	...
	"stress": "Stress ([img=24x24]res://addons/cfc/fonts/rich_text_icons/terror.png[/img]): "\
	...
	"confidence": "Confidence ([img=24x24]res://addons/cfc/fonts/rich_text_icons/shield.png[/img]): "\
			+ "Anxiety from Torment intents reduces confidence "\
			+ "before increasing the dreamer's anxiety.\n",
	"perplexity": "Perplexity ([img=24x24]res://addons/cfc/fonts/rich_text_icons/shield.png[/img]): "\
			+ "Interpretation done by the Dreamer reduces perplexity "\
			+ "before affecting the Torments.",
	"immersion": "Immersion ([img=24x24]res://addons/cfc/fonts/rich_text_icons/concentration-orb.png[/img]): "\
